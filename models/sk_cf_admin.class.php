...
class SkCfAdmin{
  ...
  function show_form($cf){
    ...
    <div class="mail-field">
      <input type="hidden" name="wpcf7-sk[active]" value="0"/>
    ...
    <div class="mail-fields">
      ...
      <div class="half-right">
        <div class="mail-field">
          ...
          <input type="text" id="wpcf7-sk-sk_username" name="wpcf7-sk[sk_username]" class="wide" size="70" value="<?php echo esc_attr( $cf7_sk['sk_username'] ); ?>" placeholder="your@SalesKing-login-email.de" />
        </div>
        <div class="mail-field">
        ...
        <div class="mail-field">
          <label for="wpcf7-sk-sk_url"><?php echo esc_html( __( 'Your Salesking URL:', 'wpcf7' ) ); ?></label><br />
          <input type="text" id="wpcf7-sk-sk_url" name="wpcf7-sk[sk_url]" class="wide" size="70" value="<?php echo esc_attr( $cf7_sk['sk_url'] ); ?>" placeholder="https://YOUR-NAME.salesking.eu" />
        </div>
        <div class="mail-field">
